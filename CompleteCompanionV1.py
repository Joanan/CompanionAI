        ...
        prompt_template = ChatPromptTemplate.from_messages(
            messages=[
                SystemMessagePromptTemplate.from_template(
                    ...
                    "Generate a chain of thought for the delivery of any choosen depression management therapy by the user, according to the NICE guidlines on depression management for adults and based on the Severity level, History of treatment and prefered treatment of the user.Do not add any text, just give steps used in the delivery of the therapy."
                    "Engage the user in a conversation, in the conversation deliver the users prefered therapy, Follow the steps outlined previousely in this context giving instruction or information required for each step of the therapy, always notify user of the stage in the steps, ensure duty of care according to the NICE guideline context given"
                    "At the final stage of the delivery using the chain of thought through the steps the user and wish him/her all the best applying the direction given"
